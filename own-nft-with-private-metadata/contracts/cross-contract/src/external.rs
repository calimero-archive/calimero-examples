...
pub const MIN_DEPOSIT_FOR_CREATE_RECORD: u128 = 9000000000000000000000;
...
trait Callbacks {
    fn change_owner_callback(&mut self, token_id: TokenId, owner_metadata: crate::OwnerMetadata) -> Token;
